# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
# This file contains changes relating to the paper 'Show, Prefer and Tell: Incorporating
...
import tempfile
import tarfile
from evaluation.speaksee.utils import download_from_url
...
class Spice:
    ...
    def compute_score(self, gts, res):
        # Sort the keys so we can relate each individual score back to a specific id later
        imgIds = sorted(gts.keys())
        assert (imgIds == sorted(res.keys()))
        ...
        # Relate each individual score back to its corresponding id
        detailed_scores = {k: v for k, v in zip(imgIds, scores)}

        return average_score, detailed_scores
